...
<jsp:useBean id="productBean" class="Jsp.ProductBean" scope="session"></jsp:useBean>
...
<a href="Jsp4(4).jsp">Access bean properties from another page</a><br>
<a href="Jsp4(2).jsp">Use Forward action to go to Google</a><br>
